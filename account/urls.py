...
urlpatterns = [
    ...
    path('customer/<str:slug>/', views.customer, name='customer'),

    path('create_order/<str:slug>/', views.createOrder, name='create_order'),
    path('update_order/<str:slug>/', views.updateOrder, name='update_order'),
    path('delete_order/<str:slug>/', views.deleteOrder, name='delete_order'),
